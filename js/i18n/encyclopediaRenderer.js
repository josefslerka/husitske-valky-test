...
function renderCommandersTab() {
    ...
    const crusaders = isEnglish ? [
        ...
        {name: 'Frederick IV of Saxony (the Warlike)', years: '1370 - 1428', desc: 'Margrave of Meissen, from 1423 Elector of Saxony. In 1426, his army launched a great crusade that ended in catastrophic defeat at Ústí nad Labem - one of the greatest defeats of the crusaders.'},
        ...
        {name: 'Fridrich IV. Saský (Bojovný)', years: '1370 - 1428', desc: 'Míšeňský markrabě a od roku 1423 saský kurfiřt. Roku 1426 jeho vojsko podniklo velkou křížovou výpravu, která skončila katastrofální porážkou u Ústí nad Labem - jednou z největších porážek křižáků.'},
